var artificialHorizon = (function() {
  ...
  function emulate()
  {
	...
	var x=getRandomInt(1,300)
	var y=getRandomInt(1,300)
	var z=getRandomInt(1,300)
//	var gamma=getRandomInt(1,300);

	updateAccelerations({ accelerationIncludingGravity: {x:x,y:y, z:z}})
	//updateOrientations({gamma:gamma })  
